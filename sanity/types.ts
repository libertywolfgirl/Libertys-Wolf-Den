...
// Query: *[_type == "character" && story->slug.current == $storySlug][0]{    _id,    name,    slug,    gender,    age,    species,    description,    "story": story->{      title,      slug    },    image{      "asset": asset->{        "_ref": _id,        metadata{          dimensions{            width,            height          }        }      }    },  }
export type CHARACTERS_QUERYResult = {
  _id: string;
  name: string;
  slug: Slug;
  gender: string;
